...
curl -d "firstName=Joe&lastName=May&phoneNumber=04544454775&licenseNumber=633578" -X POST http://localhost:8080/api/crew/add;
curl -d "firstName=Kev&lastName=Bloggs&phoneNumber=01226775996&licenseNumber=126558" -X POST http://localhost:8080/api/crew/add;
curl -d "firstName=Ross&lastName=Logan&phoneNumber=07922256831&licenseNumber=11458" -X POST http://localhost:8080/api/crew/add;
curl -d "firstName=Iain&lastName=Smith&phoneNumber=07933356987&licenseNumber=335689" -X POST http://localhost:8080/api/crew/add;
curl -d "firstName=Stewart&lastName=Burns&phoneNumber=07633598855&licenseNumber=11257" -X POST http://localhost:8080/api/crew/add;
exit 0;